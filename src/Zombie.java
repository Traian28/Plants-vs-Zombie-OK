...
public abstract class Zombie{
	...
	protected boolean usoAtaqueEspecial;
	protected Juego juego;
	
	//CONSTRUCTOR
	public Zombie(int v,int vel, int r,int f,int c,Juego j){
		vida=v;velocidad=vel;recompensa=r;fila=f;columna=c;
		y=fila*100;x=columna*100;bloqueado=false;
		grafica=new JLabel();usoAtaqueEspecial=false;juego=j;
	}
	...
	public boolean usoAtaqueEspecial(){
		return usoAtaqueEspecial;
	}
}
